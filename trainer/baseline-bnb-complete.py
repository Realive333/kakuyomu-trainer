...
def main(args):
    ...
    save_path = f'./savepoint/bnb/{args.dataset}/{args.target}'
    ...
    with open(f'./savepoint/bnb/{args.dataset}/{res_str}.jsonl', 'a+', encoding='utf-8') as file:
