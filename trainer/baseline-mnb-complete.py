...
def main(args):
    ...
    save_path = f'./savepoint/mnb/{args.dataset}/{args.target}'
    ...
    with open(f'./savepoint/mnb/{args.dataset}/{res_str}.jsonl', 'a+', encoding='utf-8') as file:
