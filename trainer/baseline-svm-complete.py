...
def main(args):
    ...
    save_path = f'./savepoint/svm/{args.dataset}/{args.target}'
    ...
    with open(f'./savepoint/svm/{args.dataset}/{res_str}.jsonl', 'a+', encoding='utf-8') as file:
